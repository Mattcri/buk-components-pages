...
const minCO = new NationalValuesCO

const upperLimitTable = [
  { 'limit': Number(minCO.getSMLV() * 4) , 'solidarity': 0, 'subsistence': 0 },
  { 'limit': Number(minCO.getSMLV() * 16) , 'solidarity': 0.5, 'subsistence': 0.5 },
  { 'limit': Number(minCO.getSMLV() * 17) , 'solidarity': 0.5, 'subsistence': 0.7 },
  { 'limit': Number(minCO.getSMLV() * 18) , 'solidarity': 0.5, 'subsistence': 0.9 },
  { 'limit': Number(minCO.getSMLV() * 19) , 'solidarity': 0.5, 'subsistence': 1.1 },
  { 'limit': Number(minCO.getSMLV() * 20) , 'solidarity': 0.5, 'subsistence': 1.3 },
]
